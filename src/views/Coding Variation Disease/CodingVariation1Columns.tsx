...
export const allColumns: STableColumnsType<DataType> = [
  ...
  },
  {
    ...
    dataIndex: 'GenBank Accession Number',
    width: 200,
    ellipsis: true,
    key: 'GenBank Accession Number',
    resizable: true
  },
  {
    title: 'Gene',
  ...
  {
    title: 'Mutation Site',
    dataIndex: 'mutationSite',
    width: 120,
    ellipsis: true,
    key: 'mutationSite',
    resizable: true
  },
  // 修改后的 Protein Alteration 列：增加帮助图标并链接
  {
    title: (
    ...
    dataIndex: 'Protein Alteration',
    width: 240,
    ellipsis: true,
    key: 'Protein Alteration',
    resizable: true
  },
  {
    title: 'Codon Change',
    dataIndex: 'Codon Change',
    width: 240,
    ellipsis: true,
    key: 'Codon Change',
    resizable: true
  ...
  },
  {
    ...
    dataIndex: 'DiagnosticMethod',
    width: 320,
    ellipsis: true,
    key: 'DiagnosticMethod',
    resizable: true
  },
  {
    title: 'References',
    ...
    customRender: ({ text, record }) => (
      <div>
        <a href={text || '#'} target="_blank" class="bracket-links">References</a>
      </div>
    ),
    resizable: true
  },
