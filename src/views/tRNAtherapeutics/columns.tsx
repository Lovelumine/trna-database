...
export const allColumns: STableColumnsType<DataType> = [
  ...
  { title: 'View Details', dataIndex: 'pre_ENSURE_ID', width: 200, ellipsis: true, key: 'pre_ENSURE_ID', customRender: ({ text, record }) => (<div><a href={'/expanded/' + record.pre_ENSURE_ID || '#'} target="_blank" class="bracket-links">View Details</a></div>),resizable: true },
];
